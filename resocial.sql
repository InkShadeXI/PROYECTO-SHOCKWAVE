...
CREATE TABLE POST_USUARIO (
    ...
    FOREIGN KEY (ID_USUARIO_POST) REFERENCES USUARIO(ID_USUARIO) ON DELETE CASCADE,
...
CREATE TABLE COMENTARIO (
    ...
    FOREIGN KEY (ID_COMENTARIO_POST) REFERENCES POST_USUARIO(ID_POST) ON DELETE CASCADE,
    ID_COMENTARIO_USUARIO INT, -- HACE REFERENCIA AL ID DEL USUARIO QUE COMENTA EN EL POST
    FOREIGN KEY (ID_COMENTARIO_USUARIO) REFERENCES USUARIO(ID_USUARIO) ON DELETE CASCADE,
