...
function comprobar_usuario($nombre, $contraseña){
   ...
   // $res = leer_config(dirname(__FILE__)."/configuracion.json", dirname(__FILE__)."/configuracion.json");
    ...
    $ins = "select nombre_usuario, contrasena_usuario, usuario_admin, correo_usuario from usuario where nombre_usuario = '$nombre' and contrasena_usuario = '$contraseña'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {  
	...
	if($usu===false){
        ...
        session_start();
        // Guarda toda la fila resultante en $_SESSION['usuario']
