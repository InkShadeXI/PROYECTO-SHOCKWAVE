...
<head>
    ...
    <link rel="stylesheet" href="CSS/escribir_mostrar_comentarios_css.css">
...
<body>
    ...
    if (isset($_SESSION['usuario'])) {
        ...
        try {
            ...
            echo "<input type='submit' class='boton_comentario' id='boton_subir_comentario' value='Comentar'><br></form></div><br>"; 
            ...
            foreach($seleccion_comentarios as $resultado) {
                ...
                $seleccion_usuario->execute(array($resultado["ID_COMENTARIO_USUARIO"]));
